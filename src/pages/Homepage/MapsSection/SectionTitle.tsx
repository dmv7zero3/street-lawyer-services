  ...
  ({ className = "" }, ref) => {
    return (
      <div ref={ref} className={`text-center mb-12 ${className}`}>
        ...
        <p
          className="text-xl text-sls-marble-300 tracking-[0.02em] max-w-3xl mx-auto mb-4"
          style={{
            textShadow: "0 0 5px rgba(248, 246, 243, 0.1)",
          }}
        >
          Street Lawyer Services will open in the heart of Washington DC's
          Connecticut Avenue corridor
        </p>

        <div className="inline-flex items-center gap-3 px-4 py-2 border rounded-full bg-sls-gold/10 border-sls-gold/30">
          <div className="w-2 h-2 rounded-full bg-sls-gold animate-pulse"></div>
          <span
            className="text-sm font-semibold tracking-widest uppercase text-sls-gold"
            style={{
